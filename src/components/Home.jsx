        ...
        h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                ...
                <p className='text-gray-500 py-4 max-w-md'>
                    I love to work on web applications using
                    technologies like
                    HTML,CSS,Javascript,React JS, Tailwind and SQL
                </p>
                <div>
            ...
            <div>
                <img  style={{ width:"100%",height:"300px" }} src={HeroImage} alt="author" className="rounded-2xl mx-auto w-2/3
                 md:w-full"/>
            </div>
        </div>
    </div>
